...
` + J + e + ae;
    ...
    function x(e, r) {
      ...
      try {
        ...
        var o = u.DetermineComponentFrameRoot(), c = o[0], y = o[1];
        if (c && y) {
          var l = c.split(`
`), _ = y.split(`
`);
...
` + l[a].replace(
    ...
    function G(e, r, t, n, u, a) {
      if (typeof e == "string" || typeof e == "function" || e === P || e === F || e === X || e === $ || e === M || e === xe || typeof e == "object" && e !== null && (e.$$typeof === U || e.$$typeof === W || e.$$typeof === Z || e.$$typeof === L || e.$$typeof === Y || e.$$typeof === Re || e.getModuleId !== void 0)) {
        var o = r.children;
        if (o !== void 0)
          if (n)
            if (q(o)) {
...
Check the top-level render call using <` + e + ">."), r;
    ...
    var _e = we, N = Symbol.for("react.transitional.element"), Te = Symbol.for("react.portal"), P = Symbol.for("react.fragment"), X = Symbol.for("react.strict_mode"), F = Symbol.for("react.profiler"), L = Symbol.for("react.consumer"), Z = Symbol.for("react.context"), Y = Symbol.for("react.forward_ref"), $ = Symbol.for("react.suspense"), M = Symbol.for("react.suspense_list"), W = Symbol.for("react.memo"), U = Symbol.for("react.lazy"), xe = Symbol.for("react.offscreen"), I = Symbol.iterator, ye = Symbol.for("react.client.reference"), g = _e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, Q = Object.prototype.hasOwnProperty, m = Object.assign, Re = Symbol.for("react.client.reference"), q = Array.isArray, R = 0, K, D, ee, re, te, oe, ne;
    j.__reactDisabledLog = !0;
    var J, ae, z = !1, V = new (typeof WeakMap == "function" ? WeakMap : Map)(), pe = Symbol.for("react.client.reference"), ue, le = {}, se = {}, fe = {};
    h.Fragment = P, h.jsx = function(e, r, t, n, u) {
      return G(e, r, t, !1, n, u);
    }, h.jsxs = function(e, r, t, n, u) {
...
var ve;
function Ce() {
  return ve || (ve = 1, process.env.NODE_ENV === "production" ? k.exports = he() : k.exports = je()), k.exports;
}
var ke = Ce();
const Se = ({ variant: s = "primary", className: T, ...b }) => /* @__PURE__ */ ke.jsx(
  "button",
  {
    className: `px-4 py-2 font-bold text-white rounded ${s === "primary" ? "bg-blue-500 hover:bg-blue-700" : "bg-gray-500 hover:bg-gray-700"} ${T}`,
    ...b
  }
);
export {
